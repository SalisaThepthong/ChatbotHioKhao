    ...
    if customer_id:
        ...
        if recommended_food:
            ...
            if user:
                ...
                health_analysis = model.generate_content(f"ผลวิเคราะห์โภชนาการ: {recommended_food} เหมาะกับโรค: {health}").text
                analysis_result = f"ผลวิเคราะห์โภชนาการ: {recommended_food} เหมาะกับโรค: {health_analysis}"
